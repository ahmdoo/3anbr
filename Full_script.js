...
.fa.fa-paint-brush.btn.btn-primary {border-radius:14px;width:23%;height:30px;margin:0px 150px;border-width:4px!importabt;}
...
.colorsB {border-radius:14px;width:7%;height:30px;margin:3px 7px;border-width:4px;}
